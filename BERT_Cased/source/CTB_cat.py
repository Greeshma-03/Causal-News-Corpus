...
# columns for extracting in the dataset

cols = ["_id", "text", "sentence"]
rows = []
...
for i in root:
	name = i.find("_id").text
	phone = i.find("text").text
    sen = i.find("sentence").text
	rows.append({"_id": name,"text": phone,"sentence":sen})
...
# Stop words in english for removing
