...
# Extracting the bert cased model tokenizer
...
# her eInput IDs are  simply mappings between tokens and their respective IDs and
...
# loading the data accordin to the batch size here the batch size is 16 and max length is 120.We do this using the bertbasecased tokenizer
